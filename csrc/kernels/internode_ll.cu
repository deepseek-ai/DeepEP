...
//                 reg_topk_weights_vec[1] = ld_nc_global(reinterpret_cast<const float4*>(topk_weights + token_idx * num_topk + 4));
                ...
                reg_topk_weights_vec[0] = *compute_shared_topk_info_addr(shared_topk_info, idx_iteration, 1, 0);
                reg_topk_weights_vec[1] = *compute_shared_topk_info_addr(shared_topk_info, idx_iteration, 1, 1);
            }
