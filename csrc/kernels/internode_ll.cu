...
dispatch(void* packed_recv_x, void* packed_recv_x_scales,
    ...
    // Send data
    {
        ...
        for (int interesting_dst_local_expert_idx = 0; interesting_dst_local_expert_idx < num_local_experts; ++interesting_dst_local_expert_idx) {
