...
dispatch_impl(
    ...
    // Workspaces
    const auto workspace_layout = layout::EPWorkspaceLayout(workspace, 1, kNumRanks, kNumExperts);
    const auto host_workspace_layout = layout::EPWorkspaceLayout(mapped_host_workspace, 1, kNumRanks, kNumExperts);
